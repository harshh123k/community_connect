...
import EditProject from './pages/NGO/EditProject';
          ...
          >
            <Wrapper>
              <Routes>
                ...
                <Route path="/volunteer/home" element={<PrivateRoute element={<VolunteerDashboard />} />} />
                <Route path="/government/dashboard" element={<PrivateRoute element={<GovernmentDashboard />} />} />
                <Route path="/admin/dashboard" element={<PrivateRoute element={<Dashboard/>} />} />
                <Route path="/ngo/dashboard" element={<PrivateRoute element={<NGODashboard />} />} />
                ...
                <Route path="/ngo/projects/create" element={<PrivateRoute element={<CreateProject />} />} />
                <Route path="/ngo/projects/edit/:id" element={<PrivateRoute element={<EditProject />} />} />
              </Routes>
            </Wrapper>
          </div>
        </div>
